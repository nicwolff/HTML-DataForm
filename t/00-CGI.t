...
my %fields = (
	fields => [
		...
		},
		{
			...
			type => 'multiple',
			list => [ 'First', 'Second', 'Third' ],
			html => '<select name="xeb514762" id="xeb514762" multiple="multiple"><option value="First">First</option><option value="Second">Second</option><option value="Third">Third</option></select>'
		},
		{
			name => 'Number',
			type => 'number',
			value => 12345,
			html => '<input value="12345" name="x0b00108a" type="text" id="x0b00108a">'
		},
		{
			name => 'Radios',
			type => 'radios',
			list => [ 'First', 'Second', 'Third' ],
			html => '<table cellpadding=2 class="form_items"><tr><td><input ID="xf0769059_SUB_First" value="First" name="xf0769059" type="radio"></td><td class=form_label><label for="xf0769059_SUB_First">First</label></td></tr><tr><td><input ID="xf0769059_SUB_Second" value="Second" name="xf0769059" type="radio"></td><td class=form_label><label for="xf0769059_SUB_Second">Second</label></td></tr><tr><td><input ID="xf0769059_SUB_Third" value="Third" name="xf0769059" type="radio"></td><td class=form_label><label for="xf0769059_SUB_Third">Third</label></td></tr></table>'
		},
	]
);
